...
export const HistoricalCard = ({ story }: HistoricalCardProps) => {
  return (
    <BentoCard className="md:col-span-2 md:row-span-2 flex flex-col justify-between border-blue-500/20 bg-blue-500/5 group/history" delay={0.5}>
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          <History className="w-5 h-5 text-blue-400" />
          <span className="text-xs font-black text-white uppercase tracking-[0.2em]">Retro Link</span>
        </div>
        <div className="px-3 py-1 rounded-xl bg-blue-500/10 text-blue-400 text-[10px] font-black font-['JetBrains_Mono'] border border-blue-500/20 shadow-lg shadow-blue-500/10">
          T-1,825d
        </div>
      </div>
      
      <div>
        <h3 className="text-2xl font-black text-white leading-tight mb-4 group-hover/history:text-blue-400 transition-colors duration-500">
          {story.title}
        </h3>
      ...
      <div className="flex items-center gap-6 pt-8 border-t border-white/5">
        ...
        <div className="ml-auto w-12 h-12 rounded-2xl bg-white text-black flex items-center justify-center hover:bg-blue-500 hover:text-white transition-all duration-300 cursor-pointer shadow-xl">
